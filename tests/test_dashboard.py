...
class DashboardTests(unittest.TestCase):
    ...
    def test_dashboard_uses_event_stream_without_meta_refresh(self) -> None:
        html = _page(
            {
                ...
                "refined_entry_summary": "<div>entry</div>",
                "active_paper_rows": "",
                "paper_rows": "",
                "mode_summary": "",
                "report": "ok",
        ...
        self.assertIn('data-tab="grid"', html)
        self.assertIn('data-tab="micro-grid"', html)
        self.assertIn('data-tab="paper"', html)
        self.assertIn(">페이퍼<", html)
        self.assertIn('data-tab="research"', html)
        self.assertIn('data-tab="market"', html)
        self.assertIn('data-tab="strategies"', html)
        self.assertIn('id="grid-status-summary"', html)
        self.assertIn('id="micro-grid-summary"', html)
        self.assertIn('id="active-paper-rows"', html)
        self.assertIn('id="refined-entry-rows"', html)
