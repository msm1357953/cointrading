...
| `cointrading-grid-paper.timer` (1m) | Paper-only BTCUSDC regular "띠기" shadow lifecycle; no exchange orders |
...
COINTRADING_GRID_BASKET_TAKE_PROFIT_ENABLED=true
COINTRADING_GRID_BASKET_REPRICE_MIN_USDC=5
COINTRADING_GRID_POSITION_FILTER_ENABLED=true
COINTRADING_GRID_POSITION_LOOKBACK_15M_BARS=96
COINTRADING_GRID_LONG_MAX_RANGE_POSITION=0.82
COINTRADING_GRID_SHORT_MIN_RANGE_POSITION=0.18
