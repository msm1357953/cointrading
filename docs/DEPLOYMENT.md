...
- systemd units: `cointrading-telegram.service`, `cointrading-scalp-collect.timer`, `cointrading-scalp-score.timer`, `cointrading-market-regime.timer`, `cointrading-market-context.timer`, `cointrading-strategy-evaluate.timer`, `cointrading-strategy-notify.timer`, `cointrading-vibe-probe-notify.timer`, `cointrading-live-supervisor-notify.timer`, `cointrading-trade-event-notify.timer`, `cointrading-llm-report.timer`, `cointrading-scalp-engine.timer`, `cointrading-strategy-engine.timer`
